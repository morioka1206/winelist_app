class SwineWinary
  ...
  def save
    ...
    wine = SWine.new(winename: winename, winename_kana: winename_kana, salling_price: salling_price, purchase_price: purchase_price, country_id: country_id, state_id: state_id, bio_id: bio_id, comment: comment, stock: stock, winary_id: winary.id, wholesaler_id: wholesaler.id, onlist: onlist)
    wine.save
